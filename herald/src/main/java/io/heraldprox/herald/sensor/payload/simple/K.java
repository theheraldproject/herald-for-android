...
public class K {
     ...
     */
    @Nullable
    protected static Date date(@NonNull String fromString) {
     ...
     */
    @NonNull
    protected static MatchingKey[] matchingKeys(@NonNull SecretKey secretKey) {
        final int n = days;
        /**
     ...
     */
    @NonNull
    protected static ContactKey[] contactKeys(@NonNull MatchingKey matchingKey) {
        final int n = periods;
     ...
     */
    @NonNull
    protected static ContactIdentifier contactIdentifier(@NonNull ContactKey contactKey) {
