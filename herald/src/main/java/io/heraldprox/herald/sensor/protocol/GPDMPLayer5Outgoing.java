...
public interface GPDMPLayer5Outgoing {
     ...
     * @param senderPartialHash The partial hash of the senders (this device's owners) sender/recipient ID
    ...
    UUID outgoing(Date timeToAccess, // For encryption at Layers 6, 4
                  ...
                  UInt16 senderPartialHash, // Generated by Layer 6 for Layer 5
